...
const FormSignIn = ({handleSubmit, email, password, rememberme, onChange}) => {
    return (
        <form className={style.container} onSubmit={handleSubmit}>
            ...
            <div className={style.wrapperRememberAndPassword}>
                <div className={style.wrapperRememberMe}>
                    <input type="checkbox" id={"rememberme"} checked={rememberme} onChange={onChange} name={"rememberme"} value={rememberme}/>
